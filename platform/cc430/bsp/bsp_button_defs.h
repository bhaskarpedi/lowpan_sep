 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
/* Enable the internal PullUp for button #1. */
#define __bsp_BUTTON_EXTENDED_CONFIG__() st( P1OUT |= BV(__bsp_BUTTON1_BIT__); /* PullUp */ \
